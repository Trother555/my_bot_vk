...
class Behavior {
  ...
  async parseRequest (body) {
    ...
    if (type === 'message_new') {
      ...
      await log.log(log.type.request, 'Received event: ' + type)
  ...
  async handleMessage (obj) {
    await Promise.all([this.handleWithCommand(obj), this.handleWithRegex(obj), this.noMatchFound(obj)])
  }
  ...
  async noMatchFound (obj) {
    ...
    await this.handleEvent('no_match', obj)
  }
